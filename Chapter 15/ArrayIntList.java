...
// BJP code fixed (by W.P. Iverson, 2021) to import only what's needed
...
// making it Iterable<E> is one of the textbook programming projects (#2)
//
public class ArrayIntList { // implements Iterable<Integer> {
 ...
 // EXERCISE CODE GOES HERE, to keep it organized, might be on a Quiz some day???
   ...
   // EXERCISE END.  Class structure below from BJP textbook www.buildingjavaprograms.com
    ...
    private ArrayIntList(int... elements) {
